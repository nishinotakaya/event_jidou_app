...
Devise.setup do |config|
  ...
  # config.secret_key = '5d8828261a6ef6a2ac2766a8f8bf4c73d2a76d089a7295031c8d4f0e55c1d564ed8a0ccf015f8eec2f7fa39d08707e1569bb1eb95ab748d1f1a9859101e8aa66'
  ...
  # config.pepper = '029cd4710526f3c6f4de4f2a7603c8783107e6875983b909106b3db6dbf935ff186c38fc83e18109e82f02a6c2525fba3e9f76f5dd6689759a04ac056796f193'
  ...
  config.warden do |manager|
    manager.failure_app = ->(env) {
      if env['HTTP_ACCEPT']&.include?('application/json') || env['CONTENT_TYPE']&.include?('application/json')
        [401, { 'Content-Type' => 'application/json' }, ['{"error":"認証に失敗しました"}']]
      else
