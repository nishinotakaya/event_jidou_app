...
module X
  ...
  class Client
    ...
    VERIFY_URL = 'https://api.x.com/1.1/account/verify_credentials.json'.freeze
    ...
    # 接続確認
    # @return [Hash] { ok: true, screen_name: '...', id: '...' } / { ok: false, error: '...' }
    def verify
      res = http_get(VERIFY_URL)
      if res.is_a?(Net::HTTPSuccess)
        body = JSON.parse(res.body) rescue {}
        { ok: true, screen_name: body['screen_name'], id: body['id_str'], name: body['name'] }
      else
